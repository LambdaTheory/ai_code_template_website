        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-muted rounded-lg">
              ...
              <p><strong>生成时间：</strong> {data.generatedAt}</p>
              <p><strong>消息：</strong> 此页面在构建时静态生成！</p>
              <p><strong>随机数：</strong> {data.randomNumber}</p>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" asChild>
                <a href="/isr-demo" className="inline-flex items-center justify-center">
                  刷新页面
                </a>
              </Button>
            </div>
